...
namespace CommunityDevelopers2ISAController
{
    /// <summary>
    /// La classe Controller fait le lien entre la couche gérant le traitement métier
    /// appliqués aux données (couche service) et la couche gérant les données nommée 
    /// couche de données
    /// </summary>
