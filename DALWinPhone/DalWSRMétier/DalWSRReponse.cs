...
namespace DALWinPhone
{
    ...
    public class DalWSRReponse
    {
        ...
        /// </summary>
        private DalWSRSujet _Sujet;

        [DataMember]
        public DalWSRSujet Sujet
        {
            get { return _Sujet; }
            set { _Sujet = value; }
        }
        ...
        public DalWSRReponse(int id, string texte, DateTime date, DalWSRSujet sujet, DalWSRUtilisateur utilisateur)
        {
            this.Id = id;
            this.Texte = texte;
            this.Date = date;
